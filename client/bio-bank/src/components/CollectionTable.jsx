        ...
        <table className="min-w-full border-collapse rounded-xl overflow-hidden table-auto mt-8 bg-surface-200 backdrop-blur-lg backdrop-saturate-150">
            <thead>
                <tr className="text-white">
                    <th className="py-4 px-4 border-b border-line-divider">
                        Disease Term
                    </th>
                    <th className="py-4 px-4 border-b border-line-divider">
                        Title
            ...
            <tbody>
                {collections &&
                    collections.map((collection, index) => (
                        ...
                        >
                            <td className="py-2 px-2 sm:py-4 sm:px-4 text-center text-surface-600">
                                {collection.diseaseTerm}
                            </td>
                            <td className="py-2 px-2 sm:py-4 sm:px-4 text-center text-surface-600">
                                {collection.title}
                            </td>
                            <td className="py-2 px-2 sm:py-4 sm:px-4">
                                <Link
                                    to={`/collections/${collection.id}/samples`}
                                >
                                    <Button
                                        type="outline"
